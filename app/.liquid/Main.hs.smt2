...
(declare-fun fix$36$$36$dException_a6xz () Int)
...
(declare-fun fix$36$$36$dToText_a6ye () Int)
...
(declare-fun lq_anf$36$$35$$35$7205759403792825095$35$$35$d8bZ () Int)
...
(declare-fun Main.catchAllHandler () Int)
...
(declare-fun fix$36$$36$dShow_a6xH () Int)
...
(declare-fun fix$36$$36$dFromText_a6yd () Int)
...
(assert (distinct lit$36$$91$caught$93$$32$ lit$36$main lit$36$Main))
...
(assert (= (strLen lit$36$main) 4))
(assert (= (strLen lit$36$$91$caught$93$$32$) 9))
(push 1)
(push 1)
(pop 1)
(pop 1)
