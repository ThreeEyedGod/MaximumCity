...
(declare-fun snd () Int)
(declare-fun UseCases.AgricultureUseCase.preFilterTlgm () Int)
...
(declare-fun UseCases.AgricultureUseCase.placeLikeMaxText () Int)
...
(declare-fun InterfaceAdapters.Telegram.Telegram.preProcessTlgm () Int)
...
(declare-fun UseCases.AgricultureUseCase.placeLikeMinText () Int)
...
(declare-fun Data.Bool.HT.Private.$63$$58$ () Int)
