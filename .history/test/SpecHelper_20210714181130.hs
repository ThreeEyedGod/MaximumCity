...
libHBasic = describe "LibHBasic" $ do        
    describe "getKey " $ do
      it "returns for colorterm" $ Right $ getKey "COLORTERM" `shouldBe` "truecolor"
{--
...
libHAdvanced = describe "LibHAdvanced" $ do
    describe "getKey: existing Key test" $ do
        it "getKey Key Exists Test" $ Right $ getKey "COLORTERM" `shouldBe` "truecolor"
