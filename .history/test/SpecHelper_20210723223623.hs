...
import Debug.Trace
import Test.QuickCheck (expectF , listOf, suchThat, elements, Arbitrary, Property, arbitrary, quickCheck, (==>), forAll, Gen, choose)
import Helper
import Data.Aeson
...
libHProperty4 :: Spec
libHProperty4 = do
        modifyMaxSuccess (const 10) $ prop "Test: check Non-existing Keys "
            prop_checkNonExistentKeys
...
prop_checkNonExistentKeys = monadicIO $ do
              ...
              assert $ (shouldBeErr == snd j) -- compare   It should Fail
