...
import Debug.Trace
import Test.QuickCheck (elements, Arbitrary, Property, arbitrary, quickCheck, (==>), forAll, Gen, choose)
import Helper
import Data.Aeson
...
keyGen :: Gen String
keyGen = elements $ randomStrings (randomString (onlyAlpha randomChar8) 20) 50

prop_thereAndBackAgain :: Property
prop_thereAndBackAgain =
    forAll keyGen
    (\k -> (getKey k >>= DEC.fromLeft (SomeIOError k)) == MissingEnvError k)