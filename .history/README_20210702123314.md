...
## Try it out
Download Telegram. the index.html under test folder/directory here into your local PC directory . To copy, click on index_updated.html, click Raw and then save as. Then open it in your localhost. Go give it a shot.
## Prerequisites
