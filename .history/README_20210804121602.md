...
## Development Gotchas
1. Language Pragmas in main around datakinds and kindsignatures were required to make the latest aws lambda work
2. stack build kept crashing and needed more docker desktop memory resources to be allocated
3. Telegram api needed to be rebuilt to align to lts-
## Dependencies
