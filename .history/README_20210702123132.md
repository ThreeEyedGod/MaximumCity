...
### Functionality  
Weather sourcing task which uses caller's IP to get weather from a implementation of [DarkSky](https://twitter.com/alexanderrey007/status/1370733643279269889).
