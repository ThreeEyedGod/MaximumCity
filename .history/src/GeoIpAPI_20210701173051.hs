...
getPosStackError :: String -> Either (JSONPath, String) ForwardGeoData
getPosStackError town = do
  let d = eitherDecodeWith jsonEOF ifromJSON <$> getForwardGeoCodeforThis town :: Either (JSONPath, String) ForwardGeoData
  case d of
    Left e -> e
