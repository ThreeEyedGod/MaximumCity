...
getDistanceToAllRegions :: String -> [(String, Double)]
getDistanceToAllRegions plLatLon = map (\(str, to) -> (str , distance (mkGeo $ extLatLon $ getLatLongforThis pl) to)) regionLatLong
