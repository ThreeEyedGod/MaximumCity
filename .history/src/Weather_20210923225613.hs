...
_handlePirateResponse "Fail" town wll = pure $ (OpenWeatherAPI.getWeatherForTown $ Data.ByteString.Char8.unpack $ town) >>= (\weather2 -> _mkWeatherThere town weather2 wll)
_handlePirateResponse weather1 town wll  =  pure $ _mkWeatherThere town weather1 wll
