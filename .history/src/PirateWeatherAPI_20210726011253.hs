...
data DarkSkyDataPointDaily = DarkSkyDataPointDaily {
  ...
  keywordFieldLabelModifier "_precipProbability" =  
  keywordFieldLabelModifier "_precipType" :: String, 
  keywordFieldLabelModifier "_dewPoint" :: Float, 
  keywordFieldLabelModifier "_humidity" :: Float, 
  keywordFieldLabelModifier "_windSpeed" :: Float, 
  keywordFieldLabelModifier "_windGust" :: Float, 
  keywordFieldLabelModifier "_windBearing" :: Float, 
  keywordFieldLabelModifier "_cloudCover" :: Float, 
  keywordFieldLabelModifier "_uvIndex" :: Float, 
  keywordFieldLabelModifier "_visibility" = "_visibility"
