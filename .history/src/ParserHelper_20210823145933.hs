...
import Data.Attoparsec.ByteString.Char8 (isAlpha_ascii, manyTill, isHorizontalSpace, endOfLine, char, decimal, space, double, letter_ascii)
...
my_isAlpha_ascii :: Word -> Bool
my_isAlpha_ascii c = (c >= 'a' && c <= 'z') || (c >= 'A' && c <= 'Z')
