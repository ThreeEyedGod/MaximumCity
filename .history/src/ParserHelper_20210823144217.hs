...
import Data.Attoparsec.ByteString.Char8 (isDigit, manyTill, isHorizontalSpace, endOfLine, char, decimal, space, double, letter_ascii)
...
alphatextOnly  :: Parser ByteString
alphatextOnly = takeWhile (\c -> (isDigit c) eq False)
...
totalCategoryProjectsParser = do
    ...
    space
    b <- regionWaterDataParser
    return $ TotalProjectFooter a b
