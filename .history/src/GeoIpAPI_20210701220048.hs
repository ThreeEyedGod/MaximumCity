...
keywordFieldLabelModifier "_latitude" = "latitude"
keywordFieldLabelModifier "_longitude" = "longitude"
...
getLatLongforThis town = do 
  ...
  case d of
    ...
    Right geoipstuff -> return $ Data.ByteString.Char8.pack 
      (show (_latitude (_data (geoipstuff :: ForwardGeoData)))::Locdata)
