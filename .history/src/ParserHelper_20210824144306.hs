...
_takeWhileNOT :: Word8 -> Parser ByteString
_takeWhileNOT w8 = takeWhile (\c -> c /= w8 )
...
textTillCRNL = _takeWhileNOT LF && _takeWhileNOT CR

textTillPCT :: Parser ByteString
textTillPCT = _takeWhileNOT PCT
...
page8PageParser = do
    ...
    return $ Page8Page9 pageHeaders mjrPjs
