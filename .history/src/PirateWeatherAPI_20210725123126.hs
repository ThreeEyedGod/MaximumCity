  ...
  case d of
    ...
    Right stuff ->
        return $ Data.ByteString.Char8.pack $ Prelude.unlines [ --unlines sticks in newline after each element
          ...
          (catSF  "Dew Point currently Celsius " (dewPoint (currently stuff))), 
          (catSF  "Humdity now % " (100 * (humidity (currently stuff)))), 
          ...
          " ",
          (catSS  "Alert: Headline " (title (take 1 (alerts stuff)))), 
