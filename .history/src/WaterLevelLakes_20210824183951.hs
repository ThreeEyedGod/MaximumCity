...
mkRegionEntry :: DB.ByteString -> RegionEntry
mkRegionEntry div = RegionEntry 

extractMyData :: RegionEntry -> [RegionEntry] -> Maybe RegionEntry
extractMyData _ []  = Nothing
extractMyData divREtoFind xs = find (== (RegionEntry _ div waterData=)) xs