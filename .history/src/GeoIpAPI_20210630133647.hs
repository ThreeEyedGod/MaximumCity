...
jsonPositionStackURL = "https://api.positionstack.com/v1/forward"
getForwardGeoCodeforThis :: String -> String -> IO B.ByteString
getForwardGeoCodeforThis town = simpleHttp jsonPositionStackURL `X.catch` statusExceptionHandler
