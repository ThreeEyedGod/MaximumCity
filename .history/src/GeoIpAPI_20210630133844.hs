...
jsonPositionStackURL = "https://api.positionstack.com/v1/forward?access"
getForwardGeoCodeforThis :: String -> IO B.ByteString
getForwardGeoCodeforThis town = do
  let urlCall = jsonPositionStackURL ++ 
  simpleHttp jsonPositionStackURL  `X.catch` statusExceptionHandler
