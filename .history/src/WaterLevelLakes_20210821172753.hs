...
-- | parser for the pdf
textGrabberDiscard :: A.Parser ByteString
textGrabberDiscard = do 
    tgD <- A.takeWhile (\c -> c /= '\n' && c /= '\r')
    return tgD

checkParser :: A.Parser ByteString
checkParser = textGrabberDiscard

statusDateParser :: A.Parser ByteString
statusDateParser = textGrabberDiscard

topicTitleParser :: A.Parser ByteString
topicTitleParser = textGrabberDiscard
   
revenueRegionHeaderParser :: A.Parser ByteString
...
projectHeaderParser :: A.Parser ByteString
