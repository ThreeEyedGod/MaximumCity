...
_mkWeatherThere twn wt wl = Data.ByteString.Char8.pack $ (Data.ByteString.Char8.unpack twn ++ " is currently " ++ Data.ByteString.Char8.unpack wt ++ wl )

_handlePirateResponse :: WeatherText -> PlaceName -> WaterLevel -> IO TheWeatherThere
_handlePirateResponse "Fail" town wll = return $ (OpenWeatherAPI.getWeatherForTown $ Data.ByteString.Char8.unpack $ town) >>= (\weather2 -> _mkWeatherThere town weather2 wll)
_handlePirateResponse weather1 town wll  =  return $ _mkWeatherThere town weather1 wll
