...
getSpecificProjectSizeDataCategoryProjects :: String -> IO (Maybe CategoryProjects)
getSpecificProjectSizeData s 
    | (s == "Major") = Just majorMaharashtraStateProjects
    | (s == "Medium") = Just mediumMaharashtraStateProjects
    | (s == "Minor") = Just minorMaharashtraStateProjects
    | (s == "All") = Just allDamsMaharashtraStateProjects
    | otherwise = Just majorMaharashtraStateProjects
