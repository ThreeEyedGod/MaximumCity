...
getWeatherForTown town 
   | "Fail " `isPrefixOf` getLatLongforThis town = return $ "Fail:getWeatherForTown | getLatLongforThis"
   | isLeft $ getPirateWeatherSettings = return $ "Fail:getWeatherForTown | getPirateWeatherSettings "
   | otherwise = do 
