...
type InFunction = Text
type CalleeFunction = Text 
...
_returnStdFail :: InFunction -> CalleeFunction -> IO Text 
_returnStdFail withinFunction calledFunction = return $ pack $ "Fail:" ++ withinFunction ++ " | " ++ calledFunction