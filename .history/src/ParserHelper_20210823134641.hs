...
import Data.Attoparsec.ByteString.Char8 (manyTill, isHorizontalSpace, endOfLine, char, decimal, space, double, letter_ascii)
...
categoryProjectsParser :: Parser [RegionEntry]
categoryProjectsParser = manyTill regionEntryParser string "\nTotal Major Projects"
