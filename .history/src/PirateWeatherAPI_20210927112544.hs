...
_extractWeather isLeft dS = return $ Left $ unpack $ _returnStdFail "getWeatherForTown" "eitherDecode DarkSky"
_extractWeather isRight dS = do
      let Right dS = d
