...
parserightNowWeather :: IO Text 
parserightNowWeather w = Prelude.zipWith ($) (Prelude.zipWith ($) [catSF, catSS] [ "at Celsius ", ""])
                            [fahrenheitToCelsius (temperature (currently w)) , summary (currently w)]
