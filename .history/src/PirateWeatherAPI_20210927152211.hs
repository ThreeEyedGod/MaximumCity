...
_preProcessWeatherBasis :: String -> IO (LatLong , Either String Key) 
_preProcessWeatherBasis town = getLatLongforThis town >>= (\x -> pure $ (x :: LatLong , getPirateWeatherSettings))
