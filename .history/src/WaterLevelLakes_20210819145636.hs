...
data CategoryProjects = CategoryProjects {
    ...
    catrgoryProjects :: RevenueRegionHeader
    totalCaProjects :: TotalProjectFooter
}

data Page8Page9 = Page8Page9 {
    allDamsMaharashtraStateProjectsHeader :: ProjectHeader
    allDamsMaharashtraStateProjects :: RevenueRegionHeader
