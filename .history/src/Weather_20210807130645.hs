...
getWeather Nothing Nothing = liftIO $ putStrLn $ "Unhandled message: " ++ show u

getWeather _ Nothing = getTownNameWeatherFromIp preprocessedHeaders
getWeather p pl = getTownNameWeatherFromTown pl 
