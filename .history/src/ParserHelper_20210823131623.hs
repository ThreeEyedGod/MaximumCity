...
import Data.Attoparsec.ByteString.Char8 (endOfLine, char, decimal, space, double, letter_ascii)
...
parseRE :: ByteString -> IO ()
parseRE = parseTest regionWaterDataParser

parseTestWDP :: ByteString -> IO ()
parseTestWDP = parseTest regionEntryParser
