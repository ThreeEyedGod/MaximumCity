...
__extractWeather :: Either String DarkSky -> IO Text
__extractWeather eitherDarkSky
    | isLeft eitherDarkSky =  pure $ _returnStdFail "getWeatherForTown" "eitherDecode" 
__extractWeather eitherDarkSky = do
      let d = fromRight 
