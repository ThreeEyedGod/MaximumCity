...
extractMyData :: DB.ByteString -> [RegionEntry] -> Maybe RegionWaterData
extractMyData _ []  = Nothing
extractMyData div [RegionEntry {srNo = 1}, _, RegionEntry {srNo=x, revenueRegion=div, waterData=z },_] = Just z