...
getWaterLevelForPlace :: T.Text -> IO PercentLiveStorage
getWaterLevelForPlace pl = pure $ getPercentLiveToday $ extractDivisionData (TSE.encodeUtf8 "Amravati") getAllDivDataMajor
