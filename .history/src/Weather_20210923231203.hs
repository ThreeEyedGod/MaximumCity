...
_getTownNameWeatherFromTown town = (PirateWeatherAPI.getWeatherForTown $ Data.ByteString.Char8.unpack town) >>= (\w -> _handlePirateResponse w town $ getWaterLakeLevelForPlace_LiveToday_wrtStorage town >>=  _helperLivePercent)
