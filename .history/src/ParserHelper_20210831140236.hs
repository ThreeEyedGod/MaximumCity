...
page8PageParser = do
    ...
    endOfLine
    allPjs1 <- categoryProjectsParser
    endOfLine
    allPjs2 <- categoryProjectsParser
    return $ Page8Page9 pageHeaders mjrPjs medPjs minPjs allPjs1 allPjs2

categoryHeaderParser :: Parser ProjectHeader
categoryHeaderParser = textTillCRNL

categoryProjectsLinedataPauseEnd :: Parser ByteString
...
categoryProjectsLinedataParser = manyTill regionEntryParser categoryProjectsLinedataPauseEnd
