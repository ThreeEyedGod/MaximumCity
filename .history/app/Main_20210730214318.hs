...
gatewayHandler request context = do
    pure $ Right $ ApiGatewayResponse 
    
{ apiGatewayResponseStatusCode = 200,
apiGatewayResponseHeaders  = [("Access-Control-Allow-Headers", "*"), ("Content-Type", "application/json"), ("Access-Control-Allow-Origin","*"), ("Access-Control-Allow-Methods","POST,GET,OPTIONS")] False 
