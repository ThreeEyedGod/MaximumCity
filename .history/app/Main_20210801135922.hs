...
main :: IO ()
main =  do
      runLambda (pure ()) gatewayHandlerCallback
gatewayHandlerCallback :: LambdaOptions context -> IO (Either (LambdaError 'APIGatewayHandlerType) (LambdaResult 'APIGatewayHandlerType))
--gatewayHandlerCallback :: RunCallback 'APIGatewayHandlerType (Context context)
gatewayHandlerCallback context = 
