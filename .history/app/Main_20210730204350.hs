...
gatewayHandler request context = do
    let r = ApiGatewayResponse  200 [("Access-Control-Allow-Headers", "*"), ("Content-Type", "application/json"), ("Access-Control-Allow-Origin",("*"), ("Access-Control-Allow-Methods","POST,GET,OPTIONS"] False 
    pure $ Right $ r
