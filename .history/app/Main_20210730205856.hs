...
gatewayHandler request context = do
    pure $ Right ApiGatewayResponse 200 [("Access-Control-Allow-Headers", "*"), ("Content-Type", "application/json"), ("Access-Control-Allow-Origin","*"), ("Access-Control-Allow-Methods","POST,GET,OPTIONS")] "OK" False 
    pure $ Right $ r
