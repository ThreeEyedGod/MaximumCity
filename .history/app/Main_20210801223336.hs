...
main =  do
      ...
      where
            ...
            run b opts = do
                  ...
                  responsestatusCode <- H.statusCode 200
                  case decodeUtf8' b of 
                        Right responseBodyText -> return . pure . APIGatewayResult . mkApiGatewayResponse responsestatusCode responseHeaders responseBodyText
                        Left err -> error "bad!"
